...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-application-components-components-module"], {
  ...
  /***/
  function srcAppModulesApplicationComponentsComponentsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesApplicationComponentsComponentsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _smartphone_smartphone_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./smartphone/smartphone.component */
    "./src/app/modules/application/components/smartphone/smartphone.component.ts");

    function ComponentsComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "n\xB0 x");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](5, "br");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "to select the smartphone n\xB0 x ");
    ...
    function ComponentsComponent_div_8_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ComponentsComponent_div_8_Template_button_click_23_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r18);

          var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r17.onReset();
        });
    ...
    function ComponentsComponent_div_11_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selected", function ComponentsComponent_div_11_Template_app_smartphone_selected_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r22);

          var ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r21.onSelected($event);
        });
      ...
      if (rf & 2) {
        var smartphone_r19 = ctx.$implicit;
        var i_r20 = ctx.index;
    ...
    ComponentsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 12,
      vars: 3,
      consts: [[1, "row", "pb-4"], [1, "col-12", "col-sm-12", "col-md-3", "col-lg-3", "col-xl-3"], [1, "row", "p-4"], [1, "text-center", "col"], [1, "h5"], [4, "ngIf"], [1, "col-12", "col-sm-12", "col-md-9", "col-lg-9", "col-xl-9"], [1, "row"], ["class", "col-6 col-sm-6 col-md-4 col-lg-3 col-xl-3 px-2 mb-1", 4, "ngFor", "ngForOf"], ["role", "alert", 1, "alert", "alert-primary"], ["type", "button", 1, "btn", "btn-primary", "btn-sm"], [1, "card"], [1, "card-body"], [1, "card-title"], [1, "card-subtitle", "mb-2", "text-muted"], ["role", "alert", 1, "alert", "alert-info"], ["type", "button", 1, "btn", "btn-info", "btn-sm"], [1, "card", "text-center"], [1, "row", "no-gutters"], [1, "col-md-6", "pt-2", "pb-2"], ["alt", "name", 1, "card-img", 3, "src"], [1, "col-md-6"], [1, "card-subtitle", "mb-2", "text-primary", "font-weight-bold"], [1, "card-subtitle", "mb-2", "text-dark"], ["type", "button", 1, "btn", "btn-info", "btn-sm", 3, "click"], [1, "col-6", "col-sm-6", "col-md-4", "col-lg-3", "col-xl-3", "px-2", "mb-1"], [3, "smartphone", "index", "selected"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["NgForOf"], _smartphone_smartphone_component__WEBPACK_IMPORTED_MODULE_2__["SmartphoneComponent"]],
  ...
  /***/
  function srcAppModulesApplicationComponentsComponentsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _smartphone_smartphone_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./smartphone/smartphone.component */
    "./src/app/modules/application/components/smartphone/smartphone.component.ts");
    ...
    ComponentsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _components_routing_module__WEBPACK_IMPORTED_MODULE_3__["ComponentsRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ComponentsModule, {
        declarations: [_components_component__WEBPACK_IMPORTED_MODULE_2__["ComponentsComponent"], _smartphone_smartphone_component__WEBPACK_IMPORTED_MODULE_4__["SmartphoneComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _components_routing_module__WEBPACK_IMPORTED_MODULE_3__["ComponentsRoutingModule"]],
        exports: [_components_component__WEBPACK_IMPORTED_MODULE_2__["ComponentsComponent"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppModulesApplicationComponentsSmartphoneSmartphoneComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SmartphoneComponent", function () {
    ...
    var SmartphoneComponent =
    /*#__PURE__*/
    function () {
      function SmartphoneComponent() {
        _classCallCheck(this, SmartphoneComponent);

        this.selected = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
      }

      _createClass(SmartphoneComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "select",
        value: function select(smartphone) {
    ...
    SmartphoneComponent.ɵfac = function SmartphoneComponent_Factory(t) {
      return new (t || SmartphoneComponent)();
    };

    SmartphoneComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SmartphoneComponent,
      selectors: [["app-smartphone"]],
      inputs: {
      ...
      decls: 16,
      vars: 7,
      consts: [[1, "card"], [1, "row", "no-gutters"], [1, "col-md-6", "pt-2", "pb-2"], [1, "card-img", 3, "src", "alt"], [1, "col-md-6"], [1, "card-body"], ["type", "button", 1, "btn", "btn-primary", "btn-sm", 3, "click"], [1, "card-subtitle", "mb-2", "text-primary", "font-weight-bold", "pt-4"], [1, "card-subtitle", "mb-2", "text-dark"]],
      template: function SmartphoneComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SmartphoneComponent_Template_button_click_6_listener($event) {
            return ctx.select(ctx.smartphone);
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("n\xB0 ", ctx.index, "");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SmartphoneComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
//# sourceMappingURL=modules-application-components-components-module-es5.js.map