...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | modules-application-template-driven-forms-template-driven-forms-module */[__webpack_require__.e("default~modules-application-services-services-module~modules-application-template-driven-forms-templ~ebbcb88c"), __webpack_require__.e("modules-application-template-driven-forms-template-driven-forms-module")]).then(__webpack_require__.bind(null, /*! ./modules/application/template-driven-forms/template-driven-forms.module */ "./src/app/modules/application/template-driven-forms/template-driven-forms.module.ts"))
            .then(mod => mod.TemplateDrivenFormsModule)
    },
    {
        path: 'chartjs',
        loadChildren: () => __webpack_require__.e(/*! import() | modules-application-chartjs-chartjs-module */ "modules-application-chartjs-chartjs-module").then(__webpack_require__.bind(null, /*! ./modules/application/chartjs/chartjs.module */ "./src/app/modules/application/chartjs/chartjs.module.ts"))
            .then(mod => mod.ChartjsModule)
    },
    {
        path: 'services',
        loadChildren: () => Promise.all(/*! import() | modules-application-services-services-module */[__webpack_require__.e("default~modules-application-services-services-module~modules-application-template-driven-forms-templ~ebbcb88c"), __webpack_require__.e("modules-application-services-services-module")]).then(__webpack_require__.bind(null, /*! ./modules/application/services/services.module */ "./src/app/modules/application/services/services.module.ts"))
...
module.exports = __webpack_require__(/*! /Users/KaiYi.C/Documents/Project/Test/angular-example-pwa/src/main.ts */"./src/main.ts");
