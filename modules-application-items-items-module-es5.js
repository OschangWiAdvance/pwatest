...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-application-items-items-module"], {
  ...
  /***/
  function srcAppModulesApplicationItemsItemsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _items_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./items.component */
  ...
  /***/
  function srcAppModulesApplicationItemsItemsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function ItemsComponent_div_17_tr_11_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](item_r5.username);
    ...
    var STATE_KEY_ITEMS = Object(_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["makeStateKey"])('items');

    var ItemsComponent =
    /*#__PURE__*/
    function () {
      function ItemsComponent(state, itemsService, platformId, appId) {
        _classCallCheck(this, ItemsComponent);

        this.state = state;
        this.itemsService = itemsService;
        this.platformId = platformId;
        this.appId = appId; //  items: any;
      ...
      _createClass(ItemsComponent, [{
        ...
        value: function getUsers() {
          ...
          if (this.items.length === 0) {
            this.itemsService.getItems('https://jsonplaceholder.typicode.com/users').subscribe(function (items) {
              var platform = Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["isPlatformBrowser"])(_this.platformId) ? 'in the browser' : 'on the server';
              console.log("getUsers : Running ".concat(platform, " with appId=").concat(_this.appId));
              _this.items = items;
              _this.loaded = true;

              _this.state.set(STATE_KEY_ITEMS, items);
            });
          } else {
            this.loaded = true;
          }
    ...
    ItemsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ItemsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ItemsComponent_Template_button_click_10_listener($event) {
            return ctx.getUsers();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ItemsComponent_Template_button_click_12_listener($event) {
      ...
      styles: [".httpclient-table[_ngcontent-%COMP%] {\n    border-radius: 10px;\n  }\n  \n  .httpclient-table[_ngcontent-%COMP%]   table[_ngcontent-%COMP%] {\n    color: #FFFFFF;\n  }\n  \n  .httpclient-table.blue-gradient[_ngcontent-%COMP%] {\n    background: linear-gradient(40deg, #45cafc, #5664bd) !important\n  }\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
  ...
  /***/
  function srcAppModulesApplicationItemsItemsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _items_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    /*! ./items.service */
    "./src/app/modules/application/items/items.service.ts"); // import { HttpClientModule } from '@angular/common/http';
    ...
    ItemsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _items_routing_module__WEBPACK_IMPORTED_MODULE_3__["ItemsRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ItemsModule, {
        declarations: [_items_component__WEBPACK_IMPORTED_MODULE_2__["ItemsComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _items_routing_module__WEBPACK_IMPORTED_MODULE_3__["ItemsRoutingModule"]],
        exports: [_items_component__WEBPACK_IMPORTED_MODULE_2__["ItemsComponent"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppModulesApplicationItemsItemsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
...
//# sourceMappingURL=modules-application-items-items-module-es5.js.map